fragments = [
    // Ending 1 - Dream
    {"answer": "Yes, I am sure. All our sattelites confirm this.", "answers":[["Do we know why did they attack?", 1]], "type":1},
    {"answer": "The launch was detected only minutes after our military excersises began. Maybe just a misunderstading. Sadly we cannot do anything about that now.", "answers":[["What can we do?", 2]], "type":1},
    ...
    {"answer": "We cloud also target their infrastructure. Lot of it is concentreted near or in their major population centers. Therefore, as a side effect, we would case a lot of casualites to the enemy.", "answers":[["With what can we retaliate right now?", 5]], "type":1},
    {"answer": "We have around 1600 warheads. 750 in our ICBMs, 250 in our submarines, and 600 in our bombers. About 300 bombers are able to take off in around 2 minutes, if you give the order now. Majority of our submarines are currently docked, tough we have 10 deployed. They are practically undetectable, while they are submerged. So thats our backup.", "answers":[["How much time do I have to make the decision?", 6]], "type":1},
    {"answer": "Like I said, our submarines are currently our backup, so we have time with them. Our bombers need 2 mintues to launch, and another 5 to get out of the blast radius, if their base is targeted. To launch our ICBMs, you need to give the order NOW. It takes around 3 mintues to order and confirm a launch and another 2 to launch. We have some extra time, though sooner we order the launch, the better, in a few minutes, our communications may not work.", "answers":[["Launch the ICBMs", 7], ["Can we contact them?",48]], "type":1}, // Possible point of divergence Ending 1/2
    ...
    {"answer": "Yes, handbook. I completly forgot its your first day in office. It should be in in your most upper drawer.", "answers":[["Okay, I have it.", 10]], "effect":"foundHandbook", "type":1},
    ...
    {"answer": "The bombers are on their way, Sir. That's all we can do now. Now we have to wait.", "answers":[["That's all? There isn't anything else we can do? What about our citizes?", 16]], "type":1},
    {"answer": "Yes that's all, Sir. All TV and Radio stations have been broadcasting to the citizens about the incoming strikes alongside the sirens, also all EWS compatible devices have recieved a warning. All citizes have been ordered to shelter.", "answers":[["Well, at least something. And what about me?", 17]], "type":1},
    ...
    {"answer": "You remember that this morning you were given todays newspaper. Maybe something useful will be there?", "answers":[["What? We lost again?", 22], ["A secret item?", 23], ["A new AstroBattle movie?", 22]], "type":2, "effect":"foundNewspaper"},
    {"answer": "The charger has no logos, not text, its as if it was fake.", "answers":[["I am sure this is the secret item!", 24], ["Charging my phone is the last thing to do in this situation.", 23]], "type": 2},
    ...
    {"answer": "I am going to act as if that wierd and quite unnecesary joke didn't happen.", "answers":[["Oh, okay. Who's there again?", 29]], "type":1},
    {"answer": "It's me, the Minister of Defense.", "answers":[["Oh, I though you were dead.",30]], "type":1},
    ...
    {"answer": "I've authorized full-scale nuclear attack on the enemy. We have a few seconds, do you want to cancel it?", "answers":[["Yes! Cancel the attack immidetly!", 35]], "type":1},
    ...
    {"answer": "You hung up the phone. You take last look at photo of your family, and wait for those $rem_minutes$ minutes.", "answers":[["...",10002]], "type":2, "effect":"disableTimer"},
]
